...
function Contact() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    console.log(isHoverStack);
  }, [isHoverStack]);

  const handleStackMouseOver = index => {
    setIsHoverStack(index);
    console.log(stackRef.current[index].dataset.name);
  };
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout_Layout__WEBPACK_IMPORTED_MODULE_3__["default"], {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      key: index
    }, isHoverStack === index ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__.StaticImage, {
      src: "../images/icon.png",
      alt: "image",
