...
/* harmony export */ });
/* unused harmony exports buttongroup, isActive, btnGray */
// Exports
var button = "_Button-module--button--i-bR9";
var icon = "_Button-module--icon--q05Ty";
var buttongroup = "_Button-module--buttongroup--uHHtI";
var isActive = "_Button-module--isActive--KwUPA";
var btnGray = "_Button-module--btnGray--iWtod";
...
/* harmony export */   "nA": () => (/* binding */ main__contents),
/* harmony export */   "tb": () => (/* binding */ main__nav),
/* harmony export */   "zh": () => (/* binding */ isActive)
/* harmony export */ });
// Exports
var main = "_Main-module--main--2hP70";
var main__nav = "_Main-module--main__nav--KlY+d";
var isActive = "_Main-module--isActive--tOI9W";
...
/* harmony import */ var _styles_elements_Button_module_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8952);
function Button({name="버튼",type="block",size="sm",use="default",className,length,disabled=false,icon=false,iconName,iconPosition="before",customColor,ly_ref,onClick=()=>{console.log("default : 전달받은 이벤트가 없어요");}}){let defaultColor;// 커스텀 기본 색상
let darkenColor;// 커스텀 호버 색상
let transColor;// 커스텀 투명 색상
let colorClassName;// 커스텀 컬러 className
if(customColor!==undefined){colorClassName=customColor.className;defaultColor=`hsla(${customColor.hue}, ${customColor.saturation}%, ${customColor.lightness}% , 1)`;darkenColor=`hsla(${customColor.hue}, ${customColor.saturation}%, ${customColor.lightness-10}% , 1)`;transColor=`hsla(${customColor.hue}, ${customColor.saturation}%, ${customColor.lightness}% , 0)`;}return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment),null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button",{className:className?_styles_elements_Button_module_scss__WEBPACK_IMPORTED_MODULE_1__/* .button */ .LI+" "+className:_styles_elements_Button_module_scss__WEBPACK_IMPORTED_MODULE_1__/* .button */ .LI,"ly-size":size,"ly-type":type,"ly-use":use,disabled:disabled,style:length?{width:`${length}`}:{},type:"button",onClick:onClick,ref:ly_ref},iconPosition==="after"?name:"",icon?/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{className:"icon","s-box":"h-box","s-justify":"center","s-align":"center"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("i",{className:iconName+" ri-1x"})):"",iconPosition==="before"?name:""));}/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Button);
...
// EXTERNAL MODULE: external "/Users/coffeegom/Desktop/coffeelog/node_modules/react/index.js"
var index_js_ = __webpack_require__(1896);
var index_js_default = /*#__PURE__*/__webpack_require__.n(index_js_);
// EXTERNAL MODULE: ./.cache/gatsby-browser-entry.js + 4 modules
var gatsby_browser_entry = __webpack_require__(7533);
;// CONCATENATED MODULE: ./src/styles/layout/_Header.module.scss
// Exports
var mainHeader = "_Header-module--mainHeader--Tmbyk";
...
;// CONCATENATED MODULE: ./src/components/Header/PageHeader.tsx
function PageHeader({title}){return/*#__PURE__*/index_js_default().createElement("header",{className:mainHeader},/*#__PURE__*/index_js_default().createElement("div",{"s-box":"h-box","s-justify":"space-between","s-padding-right":"16px"},/*#__PURE__*/index_js_default().createElement("div",{"s-box":"h-box","s-align":"center"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(J,{src:"../../images/logo/my_logo.png",alt:"\uCEE4\uD53C\uACF0\uC758 \uB85C\uACE0\uC785\uB2C8\uB2E4.",__imageData:__webpack_require__(8529)})))));}/* harmony default export */ const Header_PageHeader = (PageHeader);
;// CONCATENATED MODULE: ./src/styles/layout/_Footer.module.scss
// Exports
var mainFooter = "_Footer-module--mainFooter--og677";

;// CONCATENATED MODULE: ./src/components/Footer/PageFooter.tsx
function PageFooter(){return/*#__PURE__*/index_js_default().createElement("footer",{className:mainFooter});}/* harmony default export */ const Footer_PageFooter = (PageFooter);
// EXTERNAL MODULE: ./src/styles/layout/_Main.module.scss
var _Main_module = __webpack_require__(5564);
;// CONCATENATED MODULE: ./src/styles/layout/_Nav.module.scss
// Exports
var pageNav = "_Nav-module--pageNav--+JmxL";

// EXTERNAL MODULE: ./src/components/Elements/Button/Button.tsx
var Button = __webpack_require__(9108);
;// CONCATENATED MODULE: ./src/components/Nav/PageNav.tsx
function PageNav(){const{0:pathState,1:setPathState}=(0,index_js_.useState)(window.location.pathname);(0,index_js_.useEffect)(()=>{setPathState(window.location.pathname);console.log(pathState);},[pathState]);return/*#__PURE__*/index_js_default().createElement("nav",{className:pageNav},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/"},/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{name:"Home",type:pathState==="/"?"block":"block-ghost"})),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:"/info"},/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{name:"About",type:pathState==="/info"?"block":"block-ghost"})));}/* harmony default export */ const Nav_PageNav = (PageNav);
// EXTERNAL MODULE: ./src/components/Provider/Provider.tsx
var Provider = __webpack_require__(6023);
;// CONCATENATED MODULE: ./src/components/Layout/Layout.tsx
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}const Layout=({pageTitle,children})=>{const isBrowser=typeof window!=="undefined";const data=(0,gatsby_browser_entry.useStaticQuery)("3159585216");const{0:windowWidthState,1:setWindowWidthState}=(0,index_js_.useState)(0);const handleWindowSize=(0,index_js_.useCallback)(()=>{setWindowWidthState(window.innerWidth);},[]);(0,index_js_.useEffect)(()=>{window.addEventListener("resize",throttle_default()(handleWindowSize,200));window.addEventListener("load",handleWindowSize);return()=>{window.removeEventListener("resize",handleWindowSize);window.removeEventListener("load",handleWindowSize);};},[handleWindowSize]);const windowDispatch=(0,index_js_.useContext)(Provider/* windowContext */.k);(0,index_js_.useEffect)(()=>{windowDispatch.changeWindowSize(_objectSpread(_objectSpread({},windowDispatch.windowSizeState),{},{width:windowWidthState}));},[windowWidthState]);return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement("title",null,pageTitle," | ",data.site.siteMetadata.title),/*#__PURE__*/index_js_default().createElement(Header_PageHeader,{title:data.site.siteMetadata.title}),isBrowser?/*#__PURE__*/index_js_default().createElement(Nav_PageNav,null):"",/*#__PURE__*/index_js_default().createElement("main",{className:_Main_module/* main */.DH},children),/*#__PURE__*/index_js_default().createElement(Footer_PageFooter,null));};/* harmony default export */ const Layout_Layout = (Layout);
...
function PostList({data}){return/*#__PURE__*/index_js_default().createElement("article",null,data.allMdx.nodes.map(node=>{return/*#__PURE__*/index_js_default().createElement("div",{key:node.id},/*#__PURE__*/index_js_default().createElement("h2",null,node.frontmatter.title),/*#__PURE__*/index_js_default().createElement("p",null,"Posted: ",node.frontmatter.date),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:`/${node.slug}/`},"go to"));}));}/* harmony default export */ const components_PostList = (PostList);
// EXTERNAL MODULE: ./src/components/Layout/Layout.tsx + 7 modules
var Layout = __webpack_require__(2112);
// EXTERNAL MODULE: ./src/components/Provider/Provider.tsx
var Provider = __webpack_require__(6023);
// EXTERNAL MODULE: ./src/components/Elements/Button/Button.tsx
var Button = __webpack_require__(9108);
// EXTERNAL MODULE: ./src/styles/elements/_Button.module.scss
var _Button_module = __webpack_require__(8952);
;// CONCATENATED MODULE: ./src/components/Elements/Button/Icon.tsx
const Icon=({className="",type="block",size="sm",use="default",iconName="ri-cloud-fill",disabled=false,ly_ref,onClick=()=>{console.log("default : 전달받은 이벤트가 없어요");}})=>{return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement("button",{className:className?_Button_module/* icon */.qv+" "+className:_Button_module/* icon */.qv,"ly-size":size,"ly-type":type,"ly-use":use,disabled:disabled,onClick:onClick,ref:ly_ref},/*#__PURE__*/index_js_default().createElement("i",{className:iconName+" ri-lg"})));};/* harmony default export */ const Button_Icon = (Icon);
;// CONCATENATED MODULE: ./src/pages/index.tsx
// markup
const IndexPage=({data})=>{const isBrowser=typeof window!=="undefined";const windowDispatch=(0,index_js_.useContext)(Provider/* windowContext */.k);const mainNavRef=(0,index_js_.useRef)(null);const handleToggleMainNav=()=>{if(windowDispatch.windowSizeState.width>757){var _mainNavRef$current;(_mainNavRef$current=mainNavRef.current)===null||_mainNavRef$current===void 0?void 0:_mainNavRef$current.classList.remove(_Main_module/* isActive */.zh);return;}else{var _mainNavRef$current2,_mainNavRef$current3,_mainNavRef$current4;(_mainNavRef$current2=mainNavRef.current)!==null&&_mainNavRef$current2!==void 0&&_mainNavRef$current2.classList.contains(_Main_module/* isActive */.zh)?(_mainNavRef$current3=mainNavRef.current)===null||_mainNavRef$current3===void 0?void 0:_mainNavRef$current3.classList.remove(_Main_module/* isActive */.zh):(_mainNavRef$current4=mainNavRef.current)===null||_mainNavRef$current4===void 0?void 0:_mainNavRef$current4.classList.add(_Main_module/* isActive */.zh);}};return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement(Helmet.Helmet,null,/*#__PURE__*/index_js_default().createElement("title",null,"coffee.log"),/*#__PURE__*/index_js_default().createElement("link",{href:"https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css",rel:"stylesheet"})),/*#__PURE__*/index_js_default().createElement(Layout/* default */.Z,{pageTitle:"coffee.log"},/*#__PURE__*/index_js_default().createElement("aside",{className:_Main_module/* main__nav */.tb,ref:mainNavRef},/*#__PURE__*/index_js_default().createElement("div",{"s-box":"h-box","s-justify":"space-between","s-align":"center"},/*#__PURE__*/index_js_default().createElement("h1",null,"\uB300 \uACF5\uC0AC\uC911!"),/*#__PURE__*/index_js_default().createElement(Button_Icon,{onClick:()=>{handleToggleMainNav();}}))),/*#__PURE__*/index_js_default().createElement("section",{className:_Main_module/* main__contents */.nA},windowDispatch.windowSizeState.width<757?/*#__PURE__*/index_js_default().createElement(Button/* default */.Z,{name:"\uCD9C\uB825\uBC84\uD2BC",onClick:()=>{handleToggleMainNav();}}):"",isBrowser?/*#__PURE__*/index_js_default().createElement(components_PostList,{data:data}):"")));};/* harmony default export */ const pages = (IndexPage);const query="125569910";
...
"use strict";
module.exports = JSON.parse('{"layout":"constrained","backgroundColor":"#080808","images":{"fallback":{"src":"/static/af93c3e6e0894c36d85e3250e80fc999/d50dc/my_logo.png","srcSet":"/static/af93c3e6e0894c36d85e3250e80fc999/ccef5/my_logo.png 50w,\\n/static/af93c3e6e0894c36d85e3250e80fc999/e53ea/my_logo.png 100w,\\n/static/af93c3e6e0894c36d85e3250e80fc999/d50dc/my_logo.png 200w","sizes":"(min-width: 200px) 200px, 100vw"},"sources":[{"srcSet":"/static/af93c3e6e0894c36d85e3250e80fc999/ebe4c/my_logo.webp 50w,\\n/static/af93c3e6e0894c36d85e3250e80fc999/49609/my_logo.webp 100w,\\n/static/af93c3e6e0894c36d85e3250e80fc999/2aea7/my_logo.webp 200w","type":"image/webp","sizes":"(min-width: 200px) 200px, 100vw"}]},"width":200,"height":40}');
